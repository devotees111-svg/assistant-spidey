...
con = sqlite3.connect("spidey.db")
cursor = con.cursor()

@eel.expose
def playAssistantSound():
    music_dir = "start_sound.mp3"
    playsound(music_dir)
    ...
    if app_name != "":
        ...
        try:
            ...
            if len(results) != 0:
                ...
                if len(results) != 0:
                    speak("Ok spidey sir, i am Opening "+query)
            ...
            speak("some error occured sir please check your codes")

       

def PlayYoutube(query):
    search_term = extract_yt_term(query)
    speak("Ok sir, I am Playing "+search_term+" on YouTube")
...
def findContact(query):
    ...
    words_to_remove = [ASSISTANT_NAME, 'make', 'a', 'to', 'phone', 'call', 'send', 'message', 'wahtsapp', 'video','tu','spidey','spider',"I","want","please","could","you","me","my","use"]
...
def whatsApp(mobile_no, message, flag, name):
    ...
    if flag == 'message':
        target_tab = 20
        jarvis_message = "alright sir, your message send successfully to "+name

    elif flag == 'call':
        target_tab = 14
        message = ''
        jarvis_message = "alright sir, I am calling to "+name

    else:
        target_tab = 13
        message = ''
        jarvis_message = "alright sir, I am starting video call with "+name
...
def sendMessage(message, mobileNo, name):
    ...
    #send
    tapEvents(968, 1170)
    speak("Alright sir,yourmessage send successfully to "+name)
